...
<body>
    ...
    <div class="container">
        ...
        <section id="summary" class="animate-on-scroll">
            ...
            <p>
                У меня восемь лет опыта в роли QA Engineer. Мой основной профиль — ручное тестирование веб‑приложений:
        ...
        <section id="experience" class="animate-on-scroll">
            ...
            <article class="job animate-on-scroll">
                ...
                <p>
                    Обеспечивал качество системы управления логистикой грузов (Web + Desktop). Выполнял полный цикл ручного тестирования, анализ требований, разработку тестовой документации, тестирование API (Postman), валидацию данных (SQL). Тесно взаимодействовал с командой разработки и аналитики.
                </p>
                <h4>Достижения:</h4>
                 <ul>
            ...
            <article class="job animate-on-scroll">
                ...
                <p class="job-dates">Февраль 2016 — Март 2022 (Москва)</p>
                 <p>
                    Проводил комплексное ручное тестирование веб- и мобильных проектов для различных заказчиков, включая функциональное, UI/UX, кросс-браузерное/кросс-платформенное, API (Postman, Swagger), регрессионное и&nbsp;тестирование доступности. Разрабатывал тестовую документацию (TestRail, Confluence) и управлял дефектами (Jira,&nbsp;Redmine).
                </p>
                <h4>Достижения:</h4>
                <ul>
