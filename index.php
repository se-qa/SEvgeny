    ...
    <div class="container">
        ...
        <section id="summary" class="animate-on-scroll">
            ...
            <p>
                ...
                SDLC, опыт создания <br>и ведения полной тестовой документации (тест-кейсы, чек-листы, баг-репорты).
            ...
            <article class="job animate-on-scroll">
                ...
                <h4>Достижения:</h4>
                 <ul>
                    ...
                    <li>Выявил и задокументировал ряд критических дефектов на этапе интеграции компонентов системы, <br>что предотвратило сбои в работе ключевых бизнес-процессов.</li>
                 </ul>
            </article>
